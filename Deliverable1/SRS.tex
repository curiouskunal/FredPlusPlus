...
\begin{enumerate}[{LF}1. ]
	...
	\item The graphical user interface shall be visual similar to cartoon
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR}1. ]
	\item The application will load on the majority of devices within 5 seconds of the user clicking the application icon.
	\item The GUI thread shall not be blocked/frozen at any time for more than 3 seconds.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{PR}1. ]
	...
	\item The application should not "drain" a phone's battery more than 15\% faster than standard usage on that device.
